...
Alls Mikroncontroller findet ein ATxmega32A4AU oder 16A4AU von Microchip Verwendung (IC1). Dieser wird über die PDI Schnittstelle auf JP2 Programmiert. Das Pinout dieses Steckers ist kompaktibel mit dem des AVR~ISP~MK~II Programiergeräts von Atmel/Microchip

\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\textwidth]{pic/Microcontroller}
...
\bibitem{ds:xmega}
  ...
  \url{ww1.microchip.com/downloads/en/DeviceDoc/ATxmega128-64-32-16A4U-DataSheet-DS40002166A.pdf}\\
  Microchip.com,
  2011-2020
...
\bibitem{ds:Flash}
  ...
  \url{ww1.microchip.com/downloads/en/DeviceDoc/20005051E.pdf}\\
  Microchip.com,
  2005-2020
...
\bibitem{ds:usb}
  ...
  \url{ftdichip.com/wp-content/uploads/2020/08/DS_FT232R.pdf}\\
  ftdichip.com, 2020
  
\bibitem{ds:temp}
  Texas Instruments Incorporated,
  \textit{LM35 datasheet},\\
  \url{ti.com/lit/gpn/lm35}\\
  TI.com,
  1999-2017
...
\bibitem{ds:light}
  ...
  \url{vishay.com/docs/81532/bpw96.pdf}\\
  vishay.com,
  2011
...
\bibitem{ds:BMP280}
  ...
  \url{bosch-sensortec.com/media/boschsensortec/downloads/datasheets/bst-bmp280-ds001.pdf}\\
  bosch-sensortec.com,
  Oktober 2021
